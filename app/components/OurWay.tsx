...
export const OurWay = () => {
    ...
    return (
        ...
        >
            <p className="text-zinc-500 text-center mb-3 md:text-xl text-md">{spanish ? 'Primero que nada te mostramos nuestra filosofia.' : 'First of all we will show you our philosophy '}</p>
            <h1 className={`text-center md:text-6xl text-4xl font-semibold ${nightMode ? 'text-white' : 'text-black'}`}>
            ...
            <div className="mt-20">
                <section>
                    <div className="flex items-center gap-5 md:w-[40%] w-[80%] mx-auto">
                        <p className={`border border-green-700 rounded-full md:px-4 px-3 md:py-2 py-1 ${nightMode ? 'text-zinc-300' : 'text-zinc-600'} md:text-2xl text-xl`}>1</p>
                        <h2 className={`${nightMode ? 'text-zinc-300' : 'text-zinc-600'} md:text-3xl text-xl font-semibold`}>
                    ...
                    <div className="flex flex-col gap-10 mt-10 items-center text-white">
                        {arrowsInfo.map((arrow, index) => (
                            <div key={index} className="flex gap-5 md:w-[35%] w-[70%] mx-auto">
                                <BsArrowReturnRight size={30} color="gray"/>
                                <div className="flex flex-col items-start ">
                                    <h1 className={`md:text-xl font-semibold ${nightMode ? 'text-zinc-300' : 'text-zinc-600'}`}>
                ...
                <section className="mt-20">
                    <div className="flex items-center gap-5 md:w-[40%] w-[80%] mx-auto">
                        <p className={`border border-green-700 rounded-full md:px-4 px-3 md:py-2 py-1 ${nightMode ? 'text-zinc-300' : 'text-zinc-600'} md:text-2xl text-xl`}>2</p>
                        <h2 className={`${nightMode ? 'text-zinc-300' : 'text-zinc-600'} md:text-3xl text-xl font-semibold`}>
