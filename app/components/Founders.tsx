                ...
                <section className={`${nightMode ? 'bg-zinc-900' : 'bg-zinc-100'} md:p-10 p-5 flex flex-col md:gap-2 gap-10 min-h-96 rounded-xl shadow-xl mt-20 md:w-[80%] w-[95%] mx-auto`}>
                    <div className="md:mx-10 mx-2 flex md:flex-row flex-col md:items-center md:gap-0 gap-5 items-start">
                        ...
                        <div className={`md:text-lg ${nightMode ? 'text-zinc-300' : 'text-zinc-800'} md:w-3/4`}>
                            {spanish
                                ? <p>Mi nombre es <span className={`font-bold bg-gradient-to-r ${nightMode ? 'from-blue-500 to-blue-200' : 'from-blue-700 to-blue-400'} bg-clip-text text-transparent`}>Camila Aznar</span> y soy desarrolladora Front-end. Actualmente, me dedico a crear soluciones visuales innovadoras, aportando creatividad y diseño a cada proyecto. Hoy trabajo en "AsNeed" como <span className="font-bold">Co-Fundadora</span>, desarrollando ideas que conectan con las necesidades de nuestros clientes.</p>
                                : <p>My name is <span className={`font-bold bg-gradient-to-r ${nightMode ? 'from-blue-500 to-blue-200' : 'from-blue-700 to-blue-400'} bg-clip-text text-transparent`}>Camila Aznar</span>, and I am a Front-end Developer. I specialize in creating innovative visual solutions, bringing creativity and design to every project. Currently, I work at "AsNeed" as a <span className="font-bold">Co-Founder</span>, developing ideas that align with the needs of our clients.</p>
                            }
                        </div>
                    </div>
